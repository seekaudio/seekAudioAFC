...
/*private String getConnectionUrl(RoomConnectionParameters connectionParameters) {
  ...
  // Handle incoming message (for direct connections) - not used in WebSocket implementation
  @Override
  public void handleIncomingMessage(String msg) {
    // WebSocket implementation doesn't use this method
    Log.w(TAG, "handleIncomingMessage called on WebSocketRTCClient - not supported");
  }
}
*/
